...
<head>
  <meta charset="UTF-8" />
  <title>Form Input LPJ Webinar</title>
...
<body>
  <div class="wrapper">
    ...
    <main class="main-content">
      <div class="content-wrapper">
        <h2 class="form-title">Form Input LPJ Webinar</h2>

        <form method="POST" action="generate_lpj_webinar.php" enctype="multipart/form-data" target="hidden_iframe" onsubmit="return validateFormClientSide() && onSubmitForm()">

          <?php
          // Identitas Kegiatan
          input_field('Nama Kegiatan', 'Nama_Kegiatan', 'text', 'Contoh: Webinar LAB ICT 2025');
          input_field('Judul Kegiatan', 'Judul_Kegiatan', 'text', 'Contoh: Memperkuat Literasi Digital');
          ...
          input_field('Nama Moderator', 'Nama_Moderator', 'select');

          // MC
          input_field('Nama MC', 'Nama_MC', 'select');

          // Poin Webinar (textarea)
          textarea_field('Poin Webinar', 'Poin_Webinar', 5, 'Jelaskan poin-poin penting webinar', true);

          // Tema Webinar
          input_field('Tema Webinar', 'Tema_Webinar', 'text', 'Contoh: Literasi Digital dan Keamanan Siber');

          // Poin-Poin Webinar (textarea)
          textarea_field('Poin-Poin Webinar', 'Poin_Poin_Webinar', 5, 'Jelaskan detail poin-poin webinar', true);
          ...
          // Kesimpulan Webinar (textarea)
          textarea_field('Kesimpulan Webinar', 'Kesimpulan_Webinar', 5, 'Tuliskan kesimpulan webinar', true);
          ...
          <div class="d-grid gap-2">
            <button type="submit" class="btn btn-submit-custom mt-3">Generate dan Kirim LPJ Webinar</button>
          </div>
        </form>
      </div>
    </main>
  ...
  function onSubmitForm() {
    setTimeout(() => {
      alert('LPJ Webinar berhasil digenerate dan dikirim!');
    }, 1500);
  }
  </script>
